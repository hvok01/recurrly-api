...
const getPrimaryEmailAddress = (clerkUser: any) => {
    ...
    const primaryEmail =
        emailAddresses.find((emailAddress: any) => emailAddress.id === primaryEmailAddressId) ||
        emailAddresses[0];
...
const buildUserName = ({ firstName, lastName, username, email } : { firstName: string, lastName: string, username: string, email: string }) => {
...
const normalizeClerkUser = (clerkUser: any) => {
...
export const syncUserFromClerk = async (clerkUser: any) => {
...
export const syncUserFromClerkId = async (clerkUserId: string) => {
